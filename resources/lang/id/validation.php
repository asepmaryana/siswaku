    ...
    */
    ...
    'custom' => [
        'foto' => [
            ...
            'mimes' => 'Kolom FOTO hanya boleh diisi file *.jpg, *.jpeg, *.png dan *.gif',
            'dimensions'    => 'FOTO harus memiliki ukuran minimal pajang 150px dan lebar 180px'
        ],
        'nama_kelas'    => [
            'required'  => 'Nama kelas harus diisi.',
            'string'    => 'Nama kelas harus string.',
            'max'       => 'Nama kelas maximum 20 karakter.'
        ],
        'email'         => [
